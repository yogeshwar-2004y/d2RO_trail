  ...
  methods: {
    ...
    async loadNextDocVer(lruId) {
      try {
        ...
        const response = await fetch(
          `/api/plan-documents/next-doc-ver/${lruId}`
        );
    ...
    async viewDocument(doc) {
      try {
        ...
        const fileUrl = `/api/files/plan-documents/${filename}`;
    ...
    async acceptDocument() {
      try {
        ...
        const url = `/api/documents/${this.documentId}/accept`;
    ...
    async checkReviewerAssignment() {
      ...
      try {
        ...
        const response = await fetch(
          `/api/assigned-reviewer?lru_name=${encodeURIComponent(
            this.lruName
    ...
    async deleteLatestDocument() {
      ...
      try {
        const response = await fetch(
          `/api/plan-documents/${latestDocument.document_id}`,
          {
            method: "DELETE",
            headers: {
              "Content-Type": "application/json",
    ...
    async loadCommentsFromBackend() {
      try {
        ...
        const response = await fetch(
          `/api/comments?document_id=${this.documentId}`
        );
    ...
    async loadAllCommentsForProject() {
      try {
        ...
        const documentsResponse = await fetch(
          `/api/lrus/${this.documentDetails.lruId}/plan-documents`
        );
        ...
        for (const doc of documentsData.documents) {
          ...
          try {
            const commentsResponse = await fetch(
              `/api/comments?document_id=${doc.document_id}`
            );
