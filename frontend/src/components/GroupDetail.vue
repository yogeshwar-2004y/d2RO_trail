  ...
  methods: {
    ...
    async loadSubTests() {
      ...
      try {
        const response = await fetch(
          `/api/test-groups/${this.groupId}/sub-tests`
        );
    ...
    async loadBulletinCounts() {
      ...
      for (const subTest of this.subTests) {
        try {
          const response = await fetch(
            `/api/sub-tests/${subTest.sub_test_id}/bulletins`
          );
          const data = await response.json();
    ...
    async updateSubTest() {
      ...
      try {
        ...
        const response = await fetch(
          `/api/sub-tests/${this.editingSubTest.sub_test_id}`,
          {
            method: "PUT",
            headers: {
              "Content-Type": "application/json",
    ...
    async deleteSubTest(subTest) {
      ...
      try {
        const response = await fetch(
          `/api/sub-tests/${subTest.sub_test_id}`,
          {
            method: "DELETE",
          }
        );
    ...
    async createBulletinsForSubTest(subTestId) {
      ...
      for (const bulletin of parentBulletins) {
        try {
          const response = await fetch(
            `/api/sub-tests/${subTestId}/bulletins`,
            {
              method: "POST",
              headers: {
                "Content-Type": "application/json",
