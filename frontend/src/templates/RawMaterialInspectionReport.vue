  ...
  methods: {
    ...
    async saveDraft() {
      try {
        ...
        const response = await fetch(
          "/api/reports/raw-material-inspection",
          {
            method: "POST",
            headers: {
    ...
    async updateReportSignature(signatureType) {
      ...
      try {
        ...
        const response = await fetch(
          `/api/reports/raw-material-inspection/${this.reportId}`,
          {
            method: "PUT",
            headers: {
              "Content-Type": "application/json",
    ...
    async notifyQAHeads() {
      try {
        ...
        const response = await fetch(
          "/api/reports/raw-material-inspection/notify",
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
    ...
    async loadReportData() {
      ...
      try {
        ...
        const response = await fetch(
          `/api/reports/raw-material-inspection/${reportCardIdToLoad}`,
          {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
    ...
    async notifyApproval() {
      try {
        ...
        const response = await fetch(
          "/api/reports/raw-material-inspection/notify-approval",
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
