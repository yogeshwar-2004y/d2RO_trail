...
GET http://localhost:8000/api/notifications/1003

// Get only unread notifications
GET http://localhost:8000/api/notifications/1003?unread_only=true

// Limit results
GET http://localhost:8000/api/notifications/1003?limit=10&unread_only=true
```

### Marking Notification as Read

```javascript
PUT http://localhost:8000/api/notifications/123/mark-read
```
...
curl http://localhost:8000/api/notifications/1003

# For QA Head (user_id=1004)
curl http://localhost:8000/api/notifications/1004
```
